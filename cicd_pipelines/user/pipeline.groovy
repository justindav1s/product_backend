...
def manageVersionData(app_name, commitId, build_tracking_git_url) {
    git url: "${build_tracking_git_url}", branch: 'master', credentialsId: '1c0e3c0a-f7bd-444e-918f-69799380d061'
    def workspace = pwd()
    def versionFileName = "version."+app_name
    ...
    sshagent(['1c0e3c0a-f7bd-444e-918f-69799380d061']) {
        ...
        sh ("git commit -m \"updating version data in ${versionFileName} to ${newVersionString}\"")
