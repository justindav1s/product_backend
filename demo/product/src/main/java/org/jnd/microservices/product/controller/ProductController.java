...
public class ProductController {
    ...
    ResponseEntity<Object[]> create(@PathVariable String productName,
        ...
        if (productType.equalsIgnoreCase(ProductType.SUV.toString()))    {
            type = ProductType.SUV;
        }
        else if (productType.equalsIgnoreCase(ProductType.SALOON.toString()))    {
            type = ProductType.SALOON;
        }
        else if (productType.equalsIgnoreCase(ProductType.HATCHBACK.toString()))    {
            type = ProductType.HATCHBACK;
        }
