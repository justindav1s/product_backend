...
public class ProductRepository extends RepositoryBase {
    ...
    public void init()  {
        ...
        getTypes().add(ProductType.SALOON.toString());
        getTypes().add(ProductType.SUV.toString());
        getTypes().add(ProductType.HATCHBACK.toString());

        getProducts().putAll(cache.getSUVs());
        getProducts().putAll(cache.getSaloons());
        getProducts().putAll(cache.getHatchbacks());
