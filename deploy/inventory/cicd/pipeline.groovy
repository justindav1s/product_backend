...
node('maven') {
    ...
    dir('src/inventory') {
        ...
        stage('Build jar') {
            ...
            sh "mvn -U -B -q -s ../settings.xml clean package -Dmaven.wagon.http.ssl.insecure=true -Dmaven.wagon.http.ssl.allowall=true -Dspring.profiles.active=dev -DskipTests"
        }
