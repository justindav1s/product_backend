        ...
        stage('Build and Tag OpenShift Image') {
            ...
            openshift.withCluster() {
                openshift.withProject("${dev_project}") {
                    ...
                    sh("docker tag ${dev_project}/${app_name}:${version} ${registry}/${dev_project}/${app_name}:${env.BUILD_NUMBER}")
                    sh("docker push ${registry}/${dev_project}/${app_name}:${env.BUILD_NUMBER}")
                }
            }
